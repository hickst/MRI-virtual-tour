var tourInfo = {
  "MRI": {
    ...
    "image": "../images/es_dot_control.jpg",
    "body": "The MRI Research scanner is a Siemens Skyra 3T machine. The small display above the scanner bore is called the DOT (Day Optimized Throughput) and shows status information concerning participant position, connected coils, and other items. Below the DOT display, on either side, are controls consisting of a jog wheel and additional buttons. These are used to position the table (via a projected crosshair light) and to adjust participant comfort settings; such as headphone volume, ambient light, and bore ventilation."
  },
  "MRIbore": {
    "title": "Scanner Bore and Coils",
    "image": "../images/es_bore_coils.jpg",
  ...
  "physioCart": {
    ...
    "image": "../images/es_physio_cart.jpg",
  ...
  "scanTable": {
    ...
    "image": "../images/es_scan_table.jpg",
  ...
  "quenchButton": {
    ...
    "image": "../images/sr_quench_button.jpg",
