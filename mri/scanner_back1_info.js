var tourInfo = {
  "displayTrolley": {
    ...
    "body": "This positionable trolley holds a 24-inch HD monitor and an eye-tracking camera. The display is used for presenting visual stimuli and a custom aluminum enclosure makes it MR-compatible. Its HD resolution (1900 x 1200 at 60Hz) is identical to the monitor in the console room and the two displays are cloned. However, using a specialized SD card, the image on this display is left-right flipped so that it can be viewed by the participant through a mirror located on top of the head coil.<br/><br/>Model Name: Cambridge Research Systems BOLDscreen MRI-compatible display."
  },
  "breastCoil": {
    "title": "Breast Coil Closet",
    "image": "../images/sb1_breast_coil_closet.jpg",
